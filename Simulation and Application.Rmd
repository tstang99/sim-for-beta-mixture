...
source("functions/pmle.beta.rand.R")
...
## Simulation for comparing different initilization methods, estimators and the computational cost
...
comp_cost <- ggplot(plot_tbl, aes(x = n, colour = expr, fill = expr)) +
  ...
  scale_colour_manual(values = pal) +
  scale_fill_manual(values = pal) +
  labs(x = "Sample size", y = "Time (s)", colour = "Estimators") +
  guides(fill = "none") +
  theme_bw() +
